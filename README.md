...
Tested with V 0.4.12

## Features

- Run as fast as C/C++/Rust even with [GC](https://en.wikipedia.org/wiki/Garbage_collection_(computer_science)), and coding style is so much fun just like scripting language. (Thanks to [V language](https://vlang.io/))
